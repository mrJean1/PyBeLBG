...
def _version():
    v = _parse_version('pybelbg/__init__.py', '__version__')
    c =  getenv('PYBELBG_DIST_RC', '')
    return v.replace('.0', '.') + c


_KeyWords = ('BD08', 'BD72', 'BD50', 'Belgium', 'BE', 'bilinear',
             'Deuxième-Nivellement-Général', 'DNG', 'hBG', 'hBG18',
             'hybrid-quasi-geoid', 'Lambert', 'Lambert-Conformal-Conic',
             'quasi-geoid', 'TAW', 'Tweede-Algemene-Waterpassing',
             'Uccle', 'Ukkel')

_requires = _parse_version('pybelbg/__pygeodesy.py', '_requires')
...
setup(name=_PACKAGE,
      packages=['pybelbg'],
      description='Pure Python Belgian hBG18 and Lambert conversions',
      version=_version(),
      ...
      url='https://GitHub.com/mrJean1/PyBeLBG',
...
#     download_url='https://GitHub.com/mrJean1/PyBeLBG',
#     entry_points={},
